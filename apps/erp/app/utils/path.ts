...
export const path = {
  to: {
    ...
    itemsWorkbench: `${x}/items/workbench`,
    inventoryWorkbench: `${x}/inventory/workbench`,
    productionWorkbench: `${x}/production/workbench`,
    purchasingWorkbench: `${x}/purchasing/workbench`,
    qualityWorkbench: `${x}/quality/workbench`,
    salesWorkbench: `${x}/sales/workbench`,
