...
const targetReadableId = "1927930603";
const holdouts = ["1927930503", "192793050201", "1927930603", "192793060201"];
const holdoutSet = new Set(holdouts);
const expectedActivatedMethodId = "make_KXhV4zJprUXSH9ZSM8rQ2Y";
const outputPath = resolve(root, "apps/erp/.codex/work/ai-routing-1927930603-post-activation-validation-20260820.json");
try {
