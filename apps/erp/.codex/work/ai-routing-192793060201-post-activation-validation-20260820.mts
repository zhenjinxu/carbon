...
const targetReadableId = "192793060201";
const holdouts = ["1927930503", "192793050201", "1927930603", "192793060201"];
const holdoutSet = new Set(holdouts);
const expectedActivatedMethodId = "make_DiECfGnbAxgKfDsf1QNDYH";
const outputPath = resolve(root, "apps/erp/.codex/work/ai-routing-192793060201-post-activation-validation-20260820.json");
try {
