...
const evaluationReadableIds = [
  "1927930503", "192793050201", "1927930603", "192793060201", "1927930202", "192793020201", "1927930206", "1927326104", "1927881101", "1927881103", "1927930801", "1927930802", "1927930803", "1927930804", "192744140302", "192769010102", "192769010103", "192788110401", "192788110402", "192788110601", "192788110602", "192793010401", "192793010402", "192793080101", "192793080201", "19276939010203"
];
const evaluationSet = new Set(evaluationReadableIds);
const outputPath = resolve(root, "apps/erp/.codex/work/ai-routing-stage4-expanded-holdout-evaluation-20260821.json");
...
try {
  ...
  for (const readableId of evaluationReadableIds) {
    ...
    const routeCandidates = Array.from(routesByItem.get(item.id)?.values() ?? []).map((operations) => ({ operations: operations.map(operationFromJobRow) })).filter((candidate) => candidate.operations.length > 0);
