...
const targetReadableId = "192793050201";
const holdouts = ["1927930503", "192793050201", "1927930603", "192793060201"];
const holdoutSet = new Set(holdouts);
const expectedActivatedMethodId = "make_MzZb6Ca6xbsjuShAfZ9n4Z";
const outputPath = resolve(root, "apps/erp/.codex/work/ai-routing-post-activation-validation-20260820.json");
try {
